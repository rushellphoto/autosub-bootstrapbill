...
def Initialize():
    ...
    OPENSUBTITLESRANK, OPENSUBTITLESLOGGED_IN, OPENSUBTTITLESSESSION, CURRENTLANG, OPENSUBTITLESUSER, OPENSUBTITLESPASSWD, OPENSUBTITLESURL, OPENSUBTITLESAPI
    ...
    OPENSUBTITLESURL = "http://www.opensubtitles.org"
